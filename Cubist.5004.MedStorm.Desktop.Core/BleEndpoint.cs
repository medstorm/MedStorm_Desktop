...
//        {
//            Log.Debug("BleEndpoint.AskServerToClose");
...
//        {
//            Log.Debug("BleEndpoint.CloseApplication");
//            if (m_context != null && m_context.Clients != null)
//            {
...
//        {
//            Log.Debug("BleEndpoint: Connecting to monitor");
...
//        {
//            Log.Debug("BleEndpoint: Disconnecting monitor");
...
//        {
//            Log.Debug("BleEndpoint: SendConnectionStatus");
//            bool isPaired;
//            if (mock != null)
...
//            {
//                Log.Warning("BleEndpoint: Accepted range failure. All values are not within accepted range.");
//                return false;
//            }
