    ...
    public static class QALogTemplates
    {
        public static readonly Dictionary<QALogUseCase, QALogTemplate> Templates = new()
        {
            [QALogUseCase.PretermInfants] = new QALogTemplate
            {
                ...
                Interventions = new()
                {
                    // "No interventions" removed, "Select..." handled in code-behind!
                    "During suction from traches", "During change of bandage", "During heel stick", "During other procedural painful events", "During diaper change",
                    "Increase dose of opioids", "Increase dose of alfa2 agonists", "Increase dose of midazolam", "Decrease dose of opioids", "Decrease dose of alfa2 agonists", "Decrease dose of midazolam",
                    "Entering postoperative setting", "Leaving postoperative setting"
                },
                InputParameters = new()
                {
                    ...
                    "SNAP-II score (0-155)",
                    "Finnegan (0-46)",
                    "Observational PainScore (score)",
                    "PainSensor index (0-10)",
                    ...
                    "Heart rate (bpm)",
                    "Analgesic drug",    // Drug dropdown (units in dropdown)
                    "Hypnotic drug"      // Drug dropdown (units in dropdown)
                },
                OutcomeParameters = new()
                {
                    "Wean off ventilation time (mins)",
                    "Length of ventilation (mins)",
                    "Length of oxygen need (mins)",
                    "Opioid consumption per day (mg)",
                    "Belly ache / guts moving (mins)",
                    "Length of stay in postoperative setting (mins)",
                    "Weight gain (gram)"
                }
            },
            [QALogUseCase.ICU] = new QALogTemplate
            {
                ...
                {
                    "Entering postoperative setting", "Leaving postoperative setting",
                    "During suction from traches", "During change of bandage", "During stick for blood sampling", "During other procedural painful events",
                    "Increase dose of opioids", "Increase dose of alfa2 agonists", "Increase dose of midazolam", "Decrease dose of opioids", "Decrease dose of alfa2 agonists", "Decrease dose of hypnotics"
                },
                InputParameters = new()
                {
                    ...
                    "Weight (kg)",
                    "ASA (1-6)",
                    "Abstinence (0-no, 1-yes)",
                    "CPOT (0-8)",
                    "PainSensor index (0-10)",
                    "Ventilated (0-no, 1-yes)",
                    "Oxygen saturation (%)",
                    "FiO2 (%)",
                    "Respiratory rate (bpm)",
                    "Heart rate (bpm)",
                ...
                Interventions = new()
{
    ...
    "No intervention sedated patient",
    "Max value during Intubation",
    "Tetanic Stimulus", // <--- NEW INTERVENTION
    "Max value during incision",
    "Stop antinociceptive drugs after surgery",
    "Stop hypnotics after surgery",
    "Increase dose of anti-nociceptive drugs",
    "Decrease dose of anti-nociceptive drugs",
    "Increase dose of hypnotics",
    "Decrease dose of hypnotics",
    "Max value during extubation"
},
                ...
                InputParameters = new()
                {
                    ...
                    "Weight (kg)",
                    "ASA",
                    "Spontaneous breathing (0-no, 1-yes)",
                    "Heart rate (bpm)",
                    "Systolic Blood pressure (mmHg)",
                    "Movement (0-no, 1-yes)",
                    "Pain Nociceptive Sensor index (0-10)",
                    "Neuro-muscular block (0-no, 1-yes)",
                    "EEG: Suppression time (mins)",
                    "Analgesic drug",    // Drug dropdown (units in dropdown)
                    "Hypnotic drug"      // Drug dropdown (units in dropdown)
                },
                OutcomeParameters = new()
                {
                    "Ventilation time during surgery (mins)",
                    "Time from stop anti-nociceptive drugs to extubation (mins)",
                    "Opioid consumption during surgery (mg)",
                    "Respiratory depression (0-no, 1-yes)",
                    "Max NRS 1st postop day (0-10)",
                    "Max PainSensor index 1st postop day (score)",
                    "Opioid use 1st postop day (mg)",
                    "Delirium 1st postop day (0-no, 1-yes)",
                    "Drowsiness 1st postop day (0-no, 1-yes)",
                    "Nausea/Vomiting 1st postop day (0-no, 1-yes)",
                    "Constipation 1st postop day (0-no, 1-yes)",
                    "Max Anxiety 1st postop day (score 1-10)",
                    "Abstinence 1st postop day (0-no, 1-yes)",
                    "Length of stay in postoperative setting (mins)"
                }
            }
        };
